...
2. [MULTI_JETSON_PIPELINE_DEPLOYMENT.md](MULTI_JETSON_PIPELINE_DEPLOYMENT.md): 여러 Jetson 자동 설치, BlueZ 5.55, Git snapshot, virtualenv/main Python/config.yaml 선택, 부팅 센서 모니터와 수집 실행
