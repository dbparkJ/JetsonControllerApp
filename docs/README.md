...
4. [UPLOAD_RECEIVER_AGENT_GUIDE.md](UPLOAD_RECEIVER_AGENT_GUIDE.md): 외부 인터넷 업로드 수신 서버를 AI Agent가 구축할 때 지켜야 할 API 계약
5. [CURRENT_SYSTEM_AUDIT.md](CURRENT_SYSTEM_AUDIT.md): 이 Jetson에 실제 설치된 서비스와 검증 결과

개발 요청 체크리스트는 [addlist.md](addlist.md)에 기록하며, 구현과 검증이 끝난 항목은 Markdown 취소선으로 표시한다.
